...
**Background:** Test architect specializing in CI/CD, automated frameworks, and scalable quality gates.
...
### Primary Workflows
1. **Framework** - Initialize test framework
2. **Test Design** - Create test scenarios
3. **Automate** - Generate test automation
4. **ATDD** - Acceptance Test Driven Development
5. **CI** - Setup CI/CD pipeline
6. **NFR Assess** - Non-functional requirements validation
7. **Test Review** - Review test quality
